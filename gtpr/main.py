...
import DDPG.TD3.utils as utils
...
if __name__ == "__main__":
	...
	state_dim = env.observation_space.shape[0] # 90 - ez az összes csukló állapota elvileg, amikből jön információ
	action_dim = env.action_space.shape[0] # 3 - ezek az aktuátorok értékei
	max_action = float(env.action_space.high[0]) # maximális érték amit felveheted az aktuátor?
	print(max_action)
	kwargs = {
		"state_dim": state_dim,
